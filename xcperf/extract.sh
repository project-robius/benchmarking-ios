...
# FPS Estimate
xcrun xctrace export --input $1-MetalSystemTrace.trace --xpath '/trace-toc/run[@number="1"]/data/table[@schema="core-animation-fps-estimate"]' --output $1-MetalSystemTrace-core-animation-fps-estimate.xml
